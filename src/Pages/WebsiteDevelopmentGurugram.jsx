    ...
    <main className="bg-gradient-to-b from-white via-slate-50 to-white">
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              ...
              <p className="mt-6 text-sm text-slate-600 leading-relaxed max-w-2xl">
                Comparing teams in Gurgaon? Use our{" "}
                <Link
                  to="/blog/choose-website-development-company-gurugram"
      ...
      <section className="container mx-auto px-4 pb-16 pt-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              text: "Clean architecture, helpful content sections, and schema-friendly pages designed to rank in Gurgaon searches.",
            },
            {
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm">
            <h2 className="text-2xl font-extrabold text-gray-900">
              Shopify + website builds for Gurgaon brands
            </h2>
            ...
            <div className="mt-4 space-y-4">
              <div>
                <h3 className="font-bold text-gray-900">
                  Do you provide Shopify development in Gurgaon (Gurugram)?
                </h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900">
                  What makes your approach “SEO-friendly” for Gurgaon?
                </h3>
                <p className="mt-1 text-gray-600">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm">
            <h2 className="text-2xl font-extrabold text-gray-900">
              What businesses in Gurgaon usually need from a website
            </h2>
            <p className="mt-3 text-gray-600 leading-relaxed">
              Gurgaon markets are competitive—people compare options quickly. Great websites are not
        ...
        <div className="mt-12 rounded-3xl bg-gradient-to-r from-blue-700 to-indigo-700 border border-white/10 p-8 flex items-center justify-between gap-4 flex-wrap shadow-lg shadow-blue-700/20">
          <div>
            <h2 className="text-2xl font-extrabold text-white">
              Ready to build a better website in Gurgaon?
            </h2>
